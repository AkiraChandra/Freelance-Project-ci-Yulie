        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <a href="{{ route('import-orders.create') }}"
                    class="group bg-slate-50 rounded-2xl shadow-sm border-2 border-slate-200 hover:border-blue-500 hover:shadow-md transition-all p-8 flex flex-col items-center text-center">
                ...
                <a href="{{ route('export-orders.create') }}"
                    class="group bg-slate-50 rounded-2xl shadow-sm border-2 border-slate-200 hover:border-orange-500 hover:shadow-md transition-all p-8 flex flex-col items-center text-center">
