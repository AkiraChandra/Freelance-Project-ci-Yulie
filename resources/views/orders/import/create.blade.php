<x-app-layout>
    ...
    <div class="py-8 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8" x-data="{ party: '' }">
            ...
            <form action="{{ route('import-orders.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="bg-slate-50 rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" disabled value="Auto-generate (XXXXX/IMP/001)"
                                class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl bg-gray-100 text-gray-400 text-sm cursor-not-allowed">
                        </div>

                        {{-- Tgl Order --}}
                        <div>
                            <label for="order_date" class="block text-sm font-bold text-gray-700 mb-1">
                                Tgl Order <span class="text-red-500">*</span>
                            </label>
                ...
                <x-container-input :order="null" :existingGroups="[]" :vendors="$vendors" :orderId="null" orderType="import" />

                {{-- ── DATES (Demurrage, Release, Return) ────────────────────── --}}
                <div class="bg-slate-50 rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                        <h3 class="font-bold text-gray-900">Tanggal Penting</h3>
                    </div>
