                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="issue" id="issue" rows="3"
                                class="w-full px-4 py-2.5 border-2 border-gray-300 rounded-xl bg-white text-gray-900 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all text-sm">{{ old('issue', $importOrder->issue) }}</textarea>
                        </div>
                    </div>
                </div>
