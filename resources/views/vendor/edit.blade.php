<x-app-layout>
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <!-- Header Section -->
            <div class="mb-8">
                <a href="{{ route('vendor.register') }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-700 rounded-lg shadow hover:shadow-md transition-all text-black dark:text-gray-100 font-bold mb-4">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                    Kembali
                </a>
                <h1 class="text-4xl font-bold text-gray-900 dark:text-white">{{ $vendor->name }}</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Pembaruan vendor dan daftar harga lokasi</p>
            </div>
            ...
            <form action="{{ route('vendor.update', $vendor) }}" method="POST" id="mainForm" class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                    <div class="px-8 py-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 border-b-2 border-gray-200 dark:border-gray-600">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-0">Informasi Vendor</h3>
                    </div>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $vendor->name) }}" required 
                                class="w-full px-5 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-black dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 transition-all font-semibold" 
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center space-x-3 cursor-pointer">
                                    <input type="radio" name="status" value="active" {{ $vendor->status === 'active' ? 'checked' : '' }} class="w-5 h-5 text-blue-600 cursor-pointer accent-blue-600">
                ...
                <!-- Price List Card -->
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                    <div class="px-8 py-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 border-b-2 border-gray-200 dark:border-gray-600 flex justify-between items-center">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-0">Daftar Harga Lokasi</h3>
                    ...
                    <div id="priceContainer" class="space-y-6">
                            @forelse ($vendor->prices as $index => $price)
                                <div class="price-row bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/40 dark:to-gray-800/40 p-6 rounded-xl border-2 border-gray-300 dark:border-gray-600">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <div>
                                            ...
                                            <input type="text" name="prices[{{ $index }}][lokasi]" value="{{ old('prices.' . $index . '.lokasi', $price->lokasi) }}" required 
                                                class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-black dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 font-semibold" 
                                                placeholder="Contoh: UG, JATENG, JATIM">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-bold text-gray-900 dark:text-white mb-2">Status</label>
                                            <select name="prices[{{ $index }}][status]" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-black dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 font-semibold">
                            ...
                            @empty
                                <div class="price-row bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/40 dark:to-gray-800/40 p-6 rounded-xl border-2 border-gray-300 dark:border-gray-600">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        ...
                                        <div>
                                            <label class="block text-sm font-bold text-gray-900 dark:text-white mb-2">Status</label>
                                            <select name="prices[0][status]" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-black dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 font-semibold">
                    ...
                    <!-- Submit Buttons -->
                    <div class="flex flex-col sm:flex-row justify-end gap-4 pt-8 mt-8 border-t-2 border-gray-200 dark:border-gray-700">
                        <a href="{{ route('vendor.register') }}" class="px-6 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-bold rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-all text-center">
                            Batal
                        </a>
    ...
    <script>
        ...
        function addPriceRow() {
            ...
            newRow.className = 'price-row bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/40 dark:to-gray-800/40 p-6 rounded-xl border-2 border-gray-300 dark:border-gray-600';
            newRow.innerHTML = `
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        <label class="block text-sm font-bold text-gray-900 dark:text-white mb-2">Lokasi/Tujuan <span class="text-red-500">*</span></label>
                        <input type="text" name="prices[${priceRowCount}][lokasi]" required 
                            class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 font-semibold" 
                            placeholder="Contoh: UG, JATENG, JATIM">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-900 dark:text-white mb-2">Status</label>
                        <select name="prices[${priceRowCount}][status]" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 font-semibold">
                            <option value="active">✓ Aktif</option>
                            <option value="inactive">✗ Non-Aktif</option>
                        </select>
                    </div>
